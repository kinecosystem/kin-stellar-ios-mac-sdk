...
public enum HorizonRequestError: Error {
    ...
    case beforeHistory(message: String, horizonErrorResponse:BeforeHistoryErrorResponse?) // HTTP Status code 410, deprecated
    ...
    case serverGone(message: String, horizonErrorResponse:ServerGoneErrorResponse?) // HTTP Status code 410
}
